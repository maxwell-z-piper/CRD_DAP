...
RH3_SN_REST_RANGE_ANGSTROM = (7730.0, 7922.0)
...
# metal-line information used in the injection/recovery tests.  THIS 8143-1902
# integration fixture uses an RL cube instead, so the interval below is a broad
# interior RL development window, not the production RH3 science choice.
RH3_FIT_REST_RANGE_ANGSTROM = (7000.0, 8250.0)
